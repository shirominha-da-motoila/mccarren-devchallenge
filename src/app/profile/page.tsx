      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="px-8 py-4 bg-purple-600 text-white font-bold text-lg hover:bg-blue-700 transform hover:scale-105 transition-all duration-200"
          >
        ...
        <div className="space-y-8">
          {!currentProfile ? (
            <div className="text-center py-20">
              <div className="inline-block p-6 mb-8 bg-gradient-to-r from-yellow-400 to-orange-500 text-white transform rotate-3">
              ...
              <button
                onClick={handleGenerateNew}
                className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold text-lg border-2 border-blue-700 hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-200"
              >
                Generate Profile
              </button>
            </div>
